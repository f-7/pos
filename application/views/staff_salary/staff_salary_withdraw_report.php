...
<div class="box box-default">
				...
				<div class="row">
				 ...
				 <div class="col-md-6">  
				    ...
				    <div class="micro-pos-group">
					  ...
					  <button type="button" class="btn btn-primary searchListOfPartnerWithdrawPrint" style="margin-left:20px; background:red">Print salary withdraw Sheet</button>
                    </div>
                </div>
  ...
  <script>
 $(document).on("click",".searchListOfPartnerWithdrawPrint",function(){
	
	var user_id=$(".user_id").val();
 
	if(user_id !="")	
	{
		 var urlx=base_url+"Salary-bonus-withdraw/staff-salary-withdraw_report-print/?user_id="+user_id;
