...
<div class="box box-default">
				...
				<div class="row">
				 ...
				 <div class="col-md-6">  
				    ...
				    <div class="micro-pos-group">
					  ...
					  <button type="button" class="btn btn-primary searchListOfPartnerInvestedPrint" style="margin-left:20px; background:red">Print Investment Sheet</button>
                    </div>
                </div>
  ...
  <script>
 $(document).on("click",".searchListOfPartnerInvestedPrint",function(){
	
	var user_id=$(".user_id").val();
 
	if(user_id !="")	
	{
		 var urlx=base_url+"Salary-bonus-withdraw/partner-invested-report-print/?user_id="+user_id;
