...
<div class="box box-default">
				...
				<div class="row">
				 ...
				 <div class="col-md-6">  
				    ...
				    <div class="micro-pos-group">
					  ...
					  <button type="button" class="btn btn-primary searchListOfPartnerWithdrawPrint" style="margin-left:20px; background:red">Print investment withdraw Sheet</button>
                    </div>
                </div>
 ...
 $(document).on("click",".searchListOfPartnerWithdrawPrint",function(){
	...
	if(user_id !="")	
	{
		 var urlx=base_url+"Salary-bonus-withdraw/partner-invested-withdraw-report_print/?user_id="+user_id;
