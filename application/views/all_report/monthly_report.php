	             	...
	             	<div class="form-group">
	                      ...
	                      <div class="col-sm-8">
	                        <select class="form-control" name="report_type"  id="report_type" required="true">		                        	
		                        	<option value="collection_schedule_daily"> Daily Collection schedule report </option>
		                        	<option value="collection_schedule"> Monthly Collection schedule report </option>
		                        	<option value="collection"> Monthly Collection report </option>
		                        	<option value="overall"> Monthly overall report </option>
		                        	<option value="loan_collection"> Monthly loan & deposit collection report </option>
		                        	<option value="daily_loan_collection"> Daily loan & deposit collection report </option>
