   ...
   $('#investment_info_table').DataTable( {
       ajax: base_url+"Partner/ajax-invested-list",
        columns: [
			...
			var edit_url=base_url+"Partner/update?id="+data.DT_RowId; 
				
				var buttonbox= (data.delete_button)?"<a href='"+edit_url+"' target='_blank'  rel='"+data.DT_RowId+"' class='action_button action_button_edit'>Edit</a><a  rel='"+data.DT_RowId+"' class='action_button action_button_delete'>Delete</a>":"---";
