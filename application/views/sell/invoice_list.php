	...
	<div class="box box-default">
			...
			<div class="box-body">
 			 <form class="form-horizontal" method="post" action="">
	             ...
	             <div class="col-sm-2">
	             	<div class="form-group">
	                      <label for="account_number" class="col-sm-4 control-label">Sell type</label>
	                      <div class="col-sm-8">
	                        <select class="form-control" name="sell_type"  id="sell_type" required="true">		                        	
		                        	<option <?php echo $sell_type=='cash'?"selected":"";?> value="cash"> Cash </option>
		                        	<option <?php echo $sell_type=='loan'?"selected":"";?> value="loan"> Loan </option>
