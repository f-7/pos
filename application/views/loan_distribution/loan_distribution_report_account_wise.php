...
<body>
		<h3>loan statement form of <?php echo strtoupper($account_info->name); ?> ref by <?php echo isset($ref->name)?$ref->name:""; ?></h3>
		...
		<table class="loan_transaction"  cellpadding="0" cellspacing="0">
			...
			<?php
			 ...
			 foreach( $loan_transaction as $d){
			 		$i++;
			 		if($d->collection_loan_amount<1 &&  $d->collection_deposit_amount<1){ continue;}
			 	?>
			<tr>
				<td><?php echo $i;?></td>
