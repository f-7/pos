...
<!-- issue_date account_number loan_amount deposit_amount installment_type installment_amount installment_duration status remark created_dateapproval -->
                  	...
                  	<div class="col-sm-6">
	                     ...
	                     <div class="form-group">
	                      ...
	                      <div class="col-sm-8">
	                        <input type="text" class="form-control" id="total_loan_amount" name="loan_amount" required="true" value=" <?php echo isset($info['loan_info']->loan_amount)?$info['loan_info']->loan_amount:"" ;?>">
	                      </div>
	                    </div>	
	                    		<div class="form-group">
			                      <label for="deposit_amount" class="col-sm-4 control-label">Collection of loan amt</label>
			                      <div class="col-sm-8">
			                        <input type="text" class="form-control" id="loan_collection" name="loan_collection" value=" <?php echo isset($info['loan_info']->deposit_amount)?$info['loan_info']->deposit_amount:"" ;?>" >
			                      </div>
			                    </div>


			             <div class="form-group">
			                      <label for="deposit_amount" class="col-sm-4 control-label">Existing of loan amt</label>
			                      <div class="col-sm-8">
			                        <input type="text" class="form-control" id="loan_amount" name="existing_loan_collection" value="" >
			                      </div>
			             </div>

			             <div class="form-group">
	                      <label for="issue_date" class="col-sm-4 control-label">Existing Loan collection date</label>
	                      <div class="col-sm-8">
	                        <input type="text" class="form-control" id="existing_loan_collection_date" name="existing_loan_collection_date" value="<?php echo  isset($info['loan_info']->issue_date)?date('d-m-Y',strtotime($info['loan_info']->issue_date)): date('d-m-Y');?>"  required="true">
	                      </div>
	                    </div>	
	                    ...
	                    <div style="display: none" class="form-group">
	                      ...
	                      <div class="col-sm-8">
	                        <input type="text" class="form-control" id="primery_deposit_amount" name="primery_deposit_amount" value="0">
	                      </div>
	                    </div>
...
<script type="text/javascript">
	...
	$("#existing_loan_collection_date").datepicker({ dateFormat: 'dd-mm-yy' });
	...
	$(document).on("keyup","#loan_collection",function(){

		existingLoanAmount();
	});

	$(document).on("keyup","#total_loan_amount",function(){

		existingLoanAmount();
	});

	function existingLoanAmount(){

		var totalAmountOfLoan = $("#total_loan_amount").val();
		var loan_collection = $("#loan_collection").val();
		$("#loan_amount").val(totalAmountOfLoan - loan_collection);
