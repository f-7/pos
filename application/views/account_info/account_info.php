...
<input type="text" name="name" class="form-control" required="required"  placeholder="English Name" style="text-transform:uppercase">
...
<input type="text" name="bangla_name" class="form-control"    placeholder="বাংলায় নাম">
...
<input type="text"  name="dob" class="form-control dob" required="required"  placeholder="Date Of Birth">
...
<input type="text" name="nid" class="form-control nid" required="required" maxlength="17" placeholder="NID No">
...
<input type="text" name="mob" class="form-control mob"  placeholder="Mobile No-1" maxlength="11" required="required" >
...
<input type="text" name="mob_2" class="form-control mob_2" maxlength="11" placeholder="Mobile No-2" >
...
<input type="text" name="spouse_name" class="form-control spouse_name"  placeholder="Spouse Name" readonly>
...
<input type="text" name="fathers_name" class="form-control"  placeholder="Father's Name" required="required">
...
<input type="text" name="mothers_name" class="form-control"  placeholder="Mother's Name" required="required">
...
<div class="col-sm-6">
<div class="col-sm-12">
<img src="" class="img-responsive img-thumbnail imagebox member_photo" alt="Member Photo">
</div>
<div class="col-sm-12">
...
<div class="col-sm-6">
<div class="col-sm-12">
<img src="" class="img-responsive img-thumbnail imagebox member_signature" alt="Member Signature">
</div>
<div class="col-sm-12">
...
<input type="text" name="nominee_name" class="form-control"  placeholder="Nominee's Name">
...
<input type="text" name="nominee_father_husband_name" class="form-control"  placeholder="Father or Husband  Name">
...
<input type="text" name="nominee_age" class="form-control nominee_age" maxlength="2"   placeholder="Age" >
...
<?=OOP::selectOptionList(OOP::relationShip(),0)?>         
</select>  					 
...
<input type="text" name="percentage" class="form-control percentage"  placeholder="Percentage (%)" maxlength="3" >
...
<div class="col-sm-6">
<div class="col-sm-12">
<img src="" class="img-responsive img-thumbnail imagebox nominee_photo" alt="Nominee Photo">
</div>
<div class="col-sm-12">
...
<button type="button" class="btn btn-default image-preview-input imageFilebox cameraButton"  onclick="openCamera('camera_box_photo','nominee_photo','camera_nominee_photo_name')" data-toggle="modal" data-target="#webcamera_photo">
<span class="glyphicon glyphicon-camera"></span>
<span class="image-preview-input-title">Open Camera</span>
</button>
...
<div class="col-sm-6">
<div class="col-sm-12">
<img src="" class="img-responsive img-thumbnail imagebox nominee_signature" alt="Nominee Signature">
</div>
<div class="col-sm-12">
...
<button type="button" class="btn btn-default image-preview-input imageFilebox cameraButton"  onclick="openCamera('camera_box_signature','nominee_signature','camera_nominee_signature_name')" data-toggle="modal" data-target="#webcamera_signature">
<span class="glyphicon glyphicon-camera"></span>
<span class="image-preview-input-title">Open Camera</span>
</button>
...
<input type="text" name="nominee_name_2" class="form-control"  placeholder="Nominee's Name">
...
<input type="text" name="nominee_father_husband_name_2" class="form-control"  placeholder="Father or Husband Name">
...
<input type="text" name="nominee_age_2" class="form-control nominee_age_2" maxlength="2"   placeholder="Age" >
...
<input type="text" name="percentage_2" class="form-control percentage_2"  placeholder="Percentage (%)" maxlength="3" >
...
<div class="col-sm-6">
<div class="col-sm-12">
<img src="" class="img-responsive img-thumbnail imagebox nominee_photo_2" alt="Nominee 2 Photo">
</div>
<div class="col-sm-12">
...
<button type="button" class="btn btn-default image-preview-input imageFilebox cameraButton"  onclick="openCamera('camera_box_photo','nominee_photo_2','camera_nominee_photo_name_2')" data-toggle="modal" data-target="#webcamera_photo">
<span class="glyphicon glyphicon-camera"></span>
<span class="image-preview-input-title">Open Camera</span>
</button>
...
<div class="col-sm-6">
<div class="col-sm-12">
<img src="" class="img-responsive img-thumbnail imagebox nominee_signature_2" alt="Nominee 2 Signature">
</div>
<div class="col-sm-12">
...
<button type="button" class="btn btn-default image-preview-input imageFilebox cameraButton"  onclick="openCamera('camera_box_signature','nominee_signature_2','camera_nominee_signature_name_2')" data-toggle="modal" data-target="#webcamera_signature">
<span class="glyphicon glyphicon-camera"></span>
<span class="image-preview-input-title">Open Camera</span>
</button>
...
<option value="">Please select</option>
	 <?php 
	   ...
	   {
	   ?>
		 <option class="dist_<?=$key->district_id?>" value="<?=$key->id?>" > <?=$key->upazila_name?></option>                         
...
<option value="">Please select</option>
 <?php 
	   ...
	   {
	   ?>
		 <option class="upazila_<?=$key->upazila_id?>" value="<?=$key->id?>" > <?=$key->post_office_name?></option>                         
...
<option value="">Please select</option>
 <?php 
   ...
   {
   ?>
	 <option class="upazila_<?=$key->post_office_id?>" value="<?=$key->id?>" > <?=$key->village_name?></option>                         
...
<span class="title_gap">Official Information</span>
		...
		<input type="text" name="account_number" class="form-control account_number" rel="<?=$numbersOFaccount?>" required="required"  placeholder="Account Number" readonly>
		...
		<?= OOP::selectOptionList(OOP::accountType(),1);?>                   		
		</select>  
 ...
 <?= OOP::selectOptionList(OOP::getArray($area_list, 'area_code','area_name'),(set_value('area_code')?set_value('area_code'):""));?>                   		
		</select>  
		...
		<option value="">  Select </option>
		 <?php 
		   ...
		   {
		   ?>
			 <option class="area_<?=$key->area_code?>" value="<?=$key->society_code?>" <?=((set_value('society_code')?set_value('society_code'):"")==$key->society_code)?'selected':''?>> <?=$key->society_name?></option>                         
...
<select class="form-control reference_pin_number" name="reference_pin_number"  >
		 ...
		 if(!empty($reference_list)){
		   ...
		   {
		   ?>
			 <option  value="<?=$key->id?>" <?=((set_value('reference_pin_number')?set_value('reference_pin_number'):"")==$key->reference_pin_number)?'selected':''?>> <?=$key->name?></option>                         
		...
		<input type="text" name="short_note" class="form-control"  placeholder="Short Note" maxlength="180">
...
<span class="headerOfTitile"> Attachment : </span>		  
	 ...
	 <input type="checkbox" name="member_nid" value="1" class="same_data_box" > NID Photocopy of Member.
	 </span>
	  <span class="full_sapn">
	 <input type="checkbox" name="nominee_nid" value="2" class="same_data_box" > NID Photocopy of Nominee.
	 </span>
	 <span class="full_sapn">
	 <input type="checkbox" name="member_photo" value="3"  class="same_data_box" > 1 copy Passport size photo of members.
	 </span>
	 <span class="full_sapn">
	 <input type="checkbox" name="nominee_photo" value="4" class="same_data_box" > 1 copy passport size photo of Nominee.
	 </span>
	 <span class="full_sapn">
	 <input type="checkbox" name="others" value="5" class="same_data_box" > Others document's.
	 </span>
  ...
  <div class="col-md-6">      
		...
		<button type="submit" class="btn btn-default btn-lg margin_top_90">Submit</button>
