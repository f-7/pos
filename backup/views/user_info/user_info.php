...
<input type="text"  value="<?=($failed)?set_value('joing_date'):""?>"    name="joing_date" class="form-control joing_date" required="required"  placeholder="Date Of Birth">
<errormessage> <?=(form_error('joing_date'))?form_error('joing_date'):""?> </errormessage>
	...
	<div class="micro-pos-group">
	   ...
	   {
	   ?>
		 <option  value="<?=$index?>" <?=(set_value('designation')==$index)?'selected':''?>> <?=$key?></option>                         
