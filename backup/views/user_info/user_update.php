...
<div class="box-header with-border">
	...
	<h3 class="box-title show-message-titile-box"><?=($message_show)?$message_show:" Update user account"?> </h3>
...
<div class="col-sm-8">
<input type="hidden" name="user_id" value="<?=$usr_data['data_list']->user_id?>"/>
...
<input type="text" value="<?=$usr_data['data_list']->name?>" name="name" class="form-control" required="required"  placeholder="English Name" style="text-transform:uppercase">
...
<input type="text"value="<?=$usr_data['data_list']->bangla_name?>"  name="bangla_name" class="form-control"    placeholder="বাংলায় নাম">
...
<input type="text" value="<?=$usr_data['data_list']->dob?>"  name="dob" class="form-control dob" required="required"  placeholder="Date Of Birth">
...
<input type="text" value="<?=$usr_data['data_list']->nid?>"   name="nid" class="form-control nid" required="required" maxlength="17" placeholder="NID No">
...
<?=OOP::selectOptionList(OOP::getGender(),$usr_data['data_list']->gender)?>         
</select>  					 
...
<input type="text"  value="<?=$usr_data['data_list']->mob?>"   name="mob" class="form-control mob"  placeholder="Mobile No-1" maxlength="11" required="required" >
...
<input type="text"  value="<?=$usr_data['data_list']->mob_2?>"   name="mob_2" class="form-control mob_2" maxlength="11" placeholder="Mobile No-2" >
...
<?=OOP::selectOptionList(OOP::getMaritalStatus(),$usr_data['data_list']->marital_status)?>                      
</select>  
...
<input type="text"  value="<?=$usr_data['data_list']->spouse_name?>"   name="spouse_name" class="form-control spouse_name"  placeholder="Spouse Name" readonly>
...
<input type="text" value="<?=$usr_data['data_list']->fathers_name?>"  name="fathers_name" class="form-control"  placeholder="Father's Name" required="required">
...
<input type="text"  value="<?=$usr_data['data_list']->mothers_name?>"   name="mothers_name" class="form-control"  placeholder="Mother's Name" required="required">
...
<div class="col-sm-6">
<div class="col-sm-12">
<img src="<?=base_url()."documents/photo/".$usr_data['data_list']->member_photo?>" class="img-responsive img-thumbnail imagebox member_photo" alt="User Photo">
</div>
<div class="col-sm-12">
...
<div class="col-sm-6">
<div class="col-sm-12">
<img src="<?=base_url()."documents/signature/".$usr_data['data_list']->member_signature?>" class="img-responsive img-thumbnail imagebox member_signature" alt="User Signature">
</div>
<div class="col-sm-12">
...
<select class="form-control present_upazila_id" name="present_upazila_id"  required="required">
	 <?php 
	   ...
	   {
	   ?>
		 <option class="dist_<?=$key->district_id?>" value="<?=$key->id?>" <?=($usr_data['data_list']->upazila_id==$key->id)?'selected':''?>> <?=$key->upazila_name?></option>                         
...
<select class="form-control present_post_office_id" name="present_post_office_id"  required="required">
 <?php 
	   ...
	   {
	   ?>
		 <option class="upazila_<?=$key->upazila_id?>" value="<?=$key->id?>" <?=($usr_data['data_list']->post_office_id==$key->id)?'selected':''?>> <?=$key->post_office_name?></option>                         
...
<select class="form-control present_village_id" name="present_village_id"  required="required">
 <?php 
   ...
   {
   ?>
	 <option class="upazila_<?=$key->post_office_id?>" value="<?=$key->id?>" <?=($usr_data['data_list']->present_address==$key->id)?'selected':''?>> <?=$key->village_name?></option>                         
...
<select class="form-control parmanentcls parmanent_upazila_id" name="parmanent_upazila_id"  required="required">
	   ...
	   {
	   ?>
		 <option class="dist_<?=$key->district_id?>" value="<?=$key->id?>" <?=($usr_data['data_list']->upazila_two_id==$key->id)?'selected':''?>> <?=$key->upazila_name?></option>                         
...
<select class="form-control parmanentcls parmanent_post_office_id" name="parmanent_post_office_id"  required="required">
 <?php 
	   ...
	   {
	   ?>
		 <option class="upazila_<?=$key->upazila_id?>" value="<?=$key->id?>" <?=($usr_data['data_list']->post_office_two_id==$key->id)?'selected':''?>> <?=$key->post_office_name?></option>                         
...
<select class="form-control parmanentcls parmanent_village_id" name="parmanent_village_id"  required="required">
 <?php 
   ...
   {
   ?>
	 <option class="upazila_<?=$key->post_office_id?>" value="<?=$key->id?>" <?=($usr_data['data_list']->permanent_address==$key->id)?'selected':''?>> <?=$key->village_name?></option>                         
...
<span class="title_gap">Official Information</span>
 ...
 <div class="micro-pos-group">
<label for="Joining Date" class="col-sm-4 control-label">Joining Date<frz>*</frz></label>
<div class="col-sm-8">

<input type="text"  value="<?=$usr_data['data_list']->joing_date?>"    name="joing_date" class="form-control joing_date" required="required"  placeholder="Joining Date">
<errormessage> <?=(form_error('joing_date'))?form_error('joing_date'):""?> </errormessage>
	...
	<div class="micro-pos-group">
		<label for="user Type" class="col-sm-4 control-label">Designation <frz>*</frz></label>
			<div class="col-sm-8">
				  
			 <select class="form-control designation" name="designation"  required="required"> 
			 
			  <?php 
			 
	   foreach(OOP::getDesignation() as $index=>$key)
	   {
	   ?>
		 <option  value="<?=$index?>" <?=($usr_data['data_list']->designation==$index)?'selected':''?>> <?=$key?></option>                         
 	...
 	<div class="micro-pos-group">
		...
		<div class="col-sm-8">
		<input type="email"  value="<?=$usr_data['data_list']->email?>"    name="email" class="form-control email"  placeholder="email" >                		
		...
		<label for="user Type" class="col-sm-4 control-label">User Type  <frz>*</frz></label>
			<div class="col-sm-8">
			 ...
			 <select class="form-control" name="type"  required="required"> 
				 <option  value="2" <?=($usr_data['data_list']->type==2)?"selected":''?>> Staff </option>  
				 <option  value="1" <?=($usr_data['data_list']->type==1)?"selected":''?>> Admin </option> 
			</select>  
  ...
  <div class="col-md-6">      
		...
		<div class="col-sm-8">
		<input type="text" value="<?=$usr_data['data_list']->username?>"   name="username" class="form-control"  placeholder="user name (max: 10 digit)" maxlength="10" minlength="6"/>                		
		...
		<div class="col-sm-8">
		<input type="checkbox" name="change_password" value="1" class="change_password"/> (If you change password)
		<input type="password" autocomplete="false" readonly   name="password" class="form-control password"  placeholder="password (min: 6 digit)"  minlength="6"/>                		
		...
		<button type="submit" class="btn btn-default btn-lg margin_top_60">Update</button>
