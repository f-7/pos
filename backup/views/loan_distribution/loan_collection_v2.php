		                    	...
		                    	<tr>
		                    		...
		                    		$number_of_istallment_paid = ($collection_loan_amount_without_exsit_collection / $installment_amount);
		                    			...
		                    			<?php if( $value->txn_coll_loan>0){ 
		                    				...
		                    				<input ins_amt="<?php  echo $value->txn_coll_loan;?>" txn_id="<?php echo $value->txn_id;?>" dist_id="<?php echo $value->id;?>" class="amt inst_amt <?php echo $col_amt == $value->txn_coll_loan? "green":"red";  ?>" type="text" name="" value="<?php echo $value->txn_coll_loan>0? $value->txn_coll_loan :$col_amt;?>"></input>


		                    				<?php }else{ echo $col_amt;}?>
		                    			...
		                    			<?php }else{ ?>
		                    				...
		                    				<input ins_amt="<?php  echo $value->installment_amount;?>" txn_id="<?php echo $value->txn_id;?>" dist_id="<?php echo $value->id;?>" class="amt inst_amt <?php echo $col_amt == $value->txn_coll_loan? "green":"red";  ?>" type="text" name="" value="<?php echo $value->txn_coll_loan>0? $value->txn_coll_loan : $col_amt;?>">
		                    		...
		                    		<td>
		                    				...
		                    				<input dep_amt="<?php echo $value->deposit_amount;?>"  txn_id="<?php echo $value->txn_id;?>" dist_id="<?php echo $value->id;?>" class="amt deposit_amt <?php echo $value->deposit_amount == $value->txn_coll_deposit? "green":"red";  ?>" type="text" name="" value="<?php echo $value->txn_coll_deposit>0 ? $value->txn_coll_deposit : $value->deposit_amount ;?>"></input>
