<div class="box box-default" style="    margin-bottom:0px">
	...
	<form action="" id="mail_info" onsubmit="return checkValidation()"  enctype="multipart/form-data"  method="post" accept-charset="utf-8">
			...
			<div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title" > Database backup to the Mail</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                  ...
                  <div class="box-body">
                    <div class="form-group" >
                      ...
                      <div class="col-sm-10">
                        <input type="email" value="nil2kanon@gmail.com"  required class="form-control toemail" id="toemail" name="toemail" placeholder="Email" style="margin-bottom:5px; ">
					...
					<div class="form-group" >
					  ...
					  ?>
                        <input type="text" value=" Database Backup (<?= $date?>) " required class="form-control subject" id="subject" name="subject" placeholder="Subject" style="margin-bottom:5px; ">
				  ...
				  <input type="checkbox" value="1" checked name="attached_file" class="attached_file"> <b> Attached Database </b>
                    <button type="submit" class="btn btn-info pull-right send_mail">Backup Database</button>
                  </div><!-- /.box-footer -->
