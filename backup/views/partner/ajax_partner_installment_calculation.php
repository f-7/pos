							...
							<tr>
								...
								<td><?php 
									if($key['pay_date'])
									{
										...
										echo "<a rel='".$key['partner_id']."' perc='".$key['Percentage']."' profit='".$key['profit_amount']."' date='".$key['last_calculation_date']."' class='action_button action_button_view' style='width:100px;color:white;background:red'><i class='fa fa-check'></i> Now Pay</a>";
