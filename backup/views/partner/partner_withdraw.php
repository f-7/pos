       ...
       ajax: base_url+"partner/ajax-partner-withdraw",
		...
		//	{ data: "status" }, 
			/*{ data: null, render: function ( data, type, row ) {   
					...
					var paid_button=(data.status_button=='1')?"<a  rel='"+data.DT_RowId+"' class='action_button action_button_view' style='float: right;width:130px;color:white;background:green'><i class='fa fa-check'></i> Now Closed</a> ":"";
				
				 
                return (data.DT_RowId)?paid_button:"---";
            } },*/			
        ],
    } );
